...
Reach a working hackathon prototype where a non-programming experimental scientist visually or conversationally creates mocked EEG and mesoscope environments, evaluates frontier and base Gemma policies, launches real Gemma training, and demonstrates the trained Gemma improving on held-out scenarios.
